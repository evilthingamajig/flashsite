...
if (legacy) {
  ...
  runtimePreload.href = 'js/candidate-preview.js?v=candidate-38';
  document.head.appendChild(runtimePreload);
  const style = document.createElement('link');
  style.rel = 'stylesheet';
  style.href = 'css/home-candidate-assembly.css?v=candidate-38';
  ...
  import('./candidate-preview.js?v=candidate-38').catch((err) => {
