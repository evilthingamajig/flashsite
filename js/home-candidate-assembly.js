...
if (legacy) {
  ...
  runtimePreload.href = 'js/candidate-preview.js?v=refined-20260909a';
  document.head.appendChild(runtimePreload);
  const style = document.createElement('link');
  style.rel = 'stylesheet';
  style.href = 'css/home-candidate-assembly.css?v=refined-20260909a';
  ...
  import('./candidate-preview.js?v=refined-20260909a').catch((err) => {
